...
enum class ModelLifecycleState { ACTIVE, DYNAMIC, RETIRED }
...
data class ModelCapabilitySnapshot(
    ...
    val isBlocked: Boolean get() = lifecycleState == ModelLifecycleState.RETIRED

    val userMessage: String
        get() = when (lifecycleState) {
            ModelLifecycleState.ACTIVE -> "生命周期已核验 · $lastVerifiedAt"
...
object ModelLifecycleRegistry {
    const val SNAPSHOT_DATE = "2026-08-11"
    ...
    private val records = listOf(
        ...
        deepSeekActive("deepseek-v4-flash"),
        deepSeekActive("deepseek-v4-pro"),
    ...
    private fun deepSeekActive(modelId: String) = ModelCapabilitySnapshot(
