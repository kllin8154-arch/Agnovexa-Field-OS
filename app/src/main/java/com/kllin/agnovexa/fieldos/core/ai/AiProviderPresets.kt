...
object AiProviderPresets {
    val all = listOf(
        AiProviderPreset("deepseek", "DeepSeek", "https://api.deepseek.com/v1", listOf("deepseek-v4-flash", "deepseek-v4-pro"), "DeepSeek 官方 OpenAI-compatible API"),
        AiProviderPreset("qwen", "阿里云百炼 · 通义千问", "https://dashscope.aliyuncs.com/compatible-mode/v1", listOf("qwen3.7-plus", "qwen-plus", "qwen-turbo"), "默认业务空间；子业务空间可再修改 Base URL"),
